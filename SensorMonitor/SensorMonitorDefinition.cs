...
namespace SensorMonitor
{
    public class SensorMonitorDefinition : PluginDefinition
    {
        ...
        internal static string GetTranslationString(string translationString, CultureInfo culture)
        {
            var currentCulture = Thread.CurrentThread.CurrentUICulture;
            Thread.CurrentThread.CurrentUICulture = culture;
            var text = Resources.Strings.ResourceManager.GetString(translationString);
            Thread.CurrentThread.CurrentUICulture = currentCulture;
            return text;
        }
        #endregion
