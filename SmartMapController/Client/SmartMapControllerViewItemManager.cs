...
namespace SmartMapController.Client
{
    ...
    /// </summary>
    public class SmartMapControllerViewItemManager : ViewItemManager
    {
        public SmartMapControllerViewItemManager() : base("SmartMapControllerViewItemManager")
        {
        }
        ...
        {
            return new SmartMapControllerViewItemWpfUserControl(this);
        }
        #endregion
