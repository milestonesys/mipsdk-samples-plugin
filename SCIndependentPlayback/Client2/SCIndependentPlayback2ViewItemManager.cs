...
namespace SCIndependentPlayback.Client2
{
	...
	/// </summary>
	public class SCIndependentPlayback2ViewItemManager : ViewItemManager
	{
		private Item _selectedCamera;

		public SCIndependentPlayback2ViewItemManager()
			: base("SCIndependentPlayback2ViewItemManager")
		{
		}
		...
		{
			return new SCIndependentPlayback2ViewItemUserControl(this);
		}
		...
		{
			return new SCIndependentPlayback2PropertiesUserControl(this);
		}
