...
namespace SCIndependentPlayback.Client2
{
	...
	/// </summary>
	public class SCIndependentPlayback2ViewItemPlugin : ViewItemPlugin
	{

		public SCIndependentPlayback2ViewItemPlugin()
		{
		}
		...
		{
			get { return SCIndependentPlaybackDefinition.SCIndependentPlayback2ViewItemPlugin; }
		}
		...
		{
			get { return "SCIndependent2Playback"; }
		}
		...
		{
			return new SCIndependentPlayback2ViewItemManager();
		}
