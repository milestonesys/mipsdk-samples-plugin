...
namespace SCIndependentPlayback.Client2
{
	...
	/// </summary>
	public partial class SCIndependentPlayback2PropertiesUserControl : PropertiesUserControl
	{
		...
		public SCIndependentPlayback2PropertiesUserControl(SCIndependentPlayback2ViewItemManager viewItemManager)
		{
		...
		private void OnSourceSelected(object sender, EventArgs e)
		{
			...
			form.Init(Configuration.Instance.GetItems(ItemHierarchy.UserDefined), ItemHierarchy.UserDefined);
