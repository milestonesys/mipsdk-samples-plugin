...
{
    // Example Shader effect from Microsoft System.Windows.Media.Effects:
    // https://docs.microsoft.com/es-es/dotnet/api/system.windows.media.effects.shadereffect?view=windowsdesktop-6.0
    public class ThresholdEffect : ShaderEffect
    {
        private static PixelShader _pixelShader =
            new PixelShader() { UriSource = new Uri(@"pack://application:,,,/SCImageViewerAddOnSample;component/Client/Effects/Shaders/ThresholdEffect.ps") };
