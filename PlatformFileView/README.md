...
- A client side application - that accesses the server service as needed
...
Note that the FileViewServer.exe needs to be started \'as administrator\'.
...
- [PlatformFileServer.csproj](javascript:clone('https://github.com/milestonesys/mipsdk-samples-plugin','src/PluginSamples.sln');)
- [PlatformFileView.csproj](javascript:clone('https://github.com/milestonesys/mipsdk-samples-plugin','src/PluginSamples.sln');)
